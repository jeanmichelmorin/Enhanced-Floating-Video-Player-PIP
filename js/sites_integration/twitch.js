window.addEventListener("load", function(event) {
	...
	let intervalId = setInterval( () => {
		...
		if (window.location.href.indexOf("twitch.tv") > -1 && 
			document.querySelector('[data-a-target="video-player"]') && // https://stackoverflow.com/questions/41361238/how-to-target-element-by-data-attribute-using-javascript
			!document.getElementById("bttv-picture-in-picture") && 
			!document.getElementById("efvp-pip-button")) {

			console.log(GLOBAL_msgPrefix + "Looking to place my PIP button...");
		...
		if (document.getElementById("bttv-picture-in-picture") && document.getElementById("efvp-pip-button") ) {

			try {

				document.getElementById("efvp-pip-button").style.display = "none"
				clearInterval(intervalId);
				console.log(GLOBAL_msgPrefix + "BTTV's PIP button was detected. We will hide our PIP button.")
